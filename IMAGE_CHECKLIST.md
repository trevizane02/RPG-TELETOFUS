...
- VIP/Tofus: use `/setvipimg vip_cover`, `/setvipimg vip_tofus_cover`, `/setvipimg vip_buy_cover`, `/setvipimg vip_chest_cover`.
...
- Dungeons (grave): d_grave_shadow_knight, d_grave_abyss_cultist, d_grave_bone_golem, d_grave_archlich (boss_dungeon)
...
- [ok] arcane_wand | Varinha Arcana (weapon, abyss)
- [ok] crystal_staff | Cajado de Cristal (weapon, desert)
- [ok] novice_rod | Cajado Novato (weapon, plains)
- [ok] grave_war_sword | Espada Tumular (weapon, grave, guerreiro, Lv 23)
- [ok] grave_arc_bow | Arco dos Ossos (weapon, grave, arqueiro, Lv 22)
- [ok] grave_mag_wand | Varinha Fúnebre (weapon, grave, mago, Lv 24)
- [ ] grave_war_lichblade | Lâmina do Lich (weapon, grave, guerreiro, Lv 28)
- [ ] grave_arc_ossuary_bow | Arco do Ossuário (weapon, grave, arqueiro, Lv 28)
- [ ] grave_mag_lichstaff | Cajado do Lich (weapon, grave, mago, Lv 28)
...
- [ok] hydra_war_amulet | Colar Pegajoso da Hidra (amulet, swamp, guerreiro, Lv 20)
- [ok] hydra_arc_amulet | Colar de Dentes da Hidra (amulet, swamp, arqueiro, Lv 20)
- [ok] hydra_mag_amulet | Colar da Cabeça da Hidra (amulet, swamp, mago, Lv 20)
- [ ] hydra_war_ring | Anel de Escamas da Hidra (ring, swamp, guerreiro, Lv 20)
- [ ] hydra_arc_ring | Anel da Hidra Caçadora (ring, swamp, arqueiro, Lv 20)
- [ ] hydra_mag_ring | Anel do Olho da Hidra (ring, swamp, mago, Lv 20)
- [ ] boots_of_haste | Boots of Haste (boots, swamp)
- [ ] grave_war_plate | Couraça do Sepultador (armor, grave, guerreiro, Lv 23)
- [ ] grave_arc_leather | Gibão do Corvo (armor, grave, arqueiro, Lv 22)
- [ ] grave_mag_robe | Manto do Lamento (armor, grave, mago, Lv 24)
- [ ] grave_war_shield | Escudo do Mausoléu (shield, grave, guerreiro, Lv 23)
- [ ] grave_arc_buckler | Broquel Silencioso (shield, grave, arqueiro, Lv 22)
- [ ] grave_mag_talisman | Égide Ritual (shield, grave, mago, Lv 24)
...
- VIP / Tofus
  ...
  - [ ] vip_chest_cover | Capa do Baú VIP semanal
